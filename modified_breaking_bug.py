# -*- coding: utf-8 -*-
"""Modified_Breaking_Bug.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1FxBNePcbuBDBQ-fypPgw0AN_E2tpUiQB
"""
...
# find the count of unique values in the dataset column
df['dataset'].nunique()
...
print("___________________________________________________________")
print("Mode of the dataset: ", df['age'].mode().values)
print("___________________________________________________________")
...
def impute_continuous_missing_data(passed_col):
    ...
    # Transform df_null with the same transformations applied to X
    for col in X.columns:
        if X[col].dtype == 'object':
            if col in df_null.copy().columns:
                df_null.copy()[col] = label_encoder.transform(df_null.copy()[col].astype(str))
            else:
                df_null.copy()[col] = label_encoder.transform(df_not_null[col].astype(str))

    # Ensure df_null_transformed has the same columns as X
    X_null = df_null.copy().drop(passed_col, axis=1, errors='ignore')

    # Impute missing values in the target column
    if len(df_null.copy()) > 0:
...
for i, col in enumerate(missing_data_cols):
    plt.subplot(3,2)
